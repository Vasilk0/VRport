...
export const projects: Project[] = [
  {
    id: 1,
    title: "Поиск Игр",
    description: "Интерактивная платформа для поиска и фильтрации видеоигр с детальными описаниями",
  ...
  },
  {
    ...
    description: "Веб-приложение с интерактивной картой для отметки мест и маршрутов",
  ...
  },
  {
    id: 3,
    title: "3D Рисование",
    description: "Приложение для рисования и моделирования в трёхмерном пространстве",
